    ...
    <div className="container mx-auto flex min-h-[80vh] items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md p-8">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-2xl font-black">ثبت‌نام / ورود</h1>
        ...
        <p className="mt-5 flex items-center justify-center gap-1 text-center text-[11px] text-muted-foreground">
          <ShieldCheck className="h-3 w-3" />
          با ثبت‌نام، <Link href="/terms" className="underline">قوانین</Link> {SITE.name} را می‌پذیرید.
        </p>
      </Card>
    </div>
  );
