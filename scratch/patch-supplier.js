...
const startIdx = content.indexOf('// Categorize products based on name/brand');
const endIdx = content.indexOf('export async function importProductsFromSupplier');
